    ...
    <div>
      {(() => {
        switch(props.type) {
          ...
          case 'loginError':
            return <UncontrolledAlert color="error">Error: Incorrect credentials. Please try again.</UncontrolledAlert>;
          case 'logoutSuccess':
          ...
          case 'signupError':
            return <UncontrolledAlert color="error">Error: Unable to register account with this username.</UncontrolledAlert>;
          ...
          case 'createBoardError':
            return <UncontrolledAlert color="error">Error: Could not create Board. Please ensure board name is unique and title is not empty.</UncontrolledAlert>;
          ...
          case 'createPostError':
            return <UncontrolledAlert color="error">Error: Could not create Post. Please ensure title is not empty.</UncontrolledAlert>;
          default:
            return null;
        }
      })()}
